...
//	// 문자열의 복사
//	//char tab[] = "abcde";
//	//cout << "strcpy 명령이 수행 전 문자열 tab의 내용은 : " << tab << " 입니다." << endl;
//	//strcpy_s(tab, "XYZ");
//	//cout << "strcpy 명령이 수행 후 문자열 tab의 내용은 : " << tab << " 입니다." << endl;
//
//	// 문자열 이어주기
//	//char tab[7] = "abc";
...
//
//	//strcat_s(tab, "XYZ");
//	//cout << "strcat 명령이 수행된 문자열의 내용은 : " << tab << endl;
//
//	// 문자열 비교
//
...
//	//cout << "비교 결과 값은 : " << n << endl << " tab과 tab2는 같다 " << endl;
//
//	// 문자열 거꾸로 출력하기
//	//cout << "문자열을 입력하세요 : ";
//	//cin.getline(tab, 100);
